...
namespace SoftwareGrid.Repository.Base
{
    public class ExecuteQuery
    {
        ...
        public object Execute(string commandText, string[] paramNames, string[] paramValues, bool isStoredProcedure = false)
        {
            ...
            var data = _dbContext.SqlConnection.Query<dynamic>(commandText, parameters,commandType: isStoredProcedure ? CommandType.StoredProcedure : CommandType.TableDirect);
