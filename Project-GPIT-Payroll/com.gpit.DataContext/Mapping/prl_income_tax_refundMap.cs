...
{
    public class prl_income_tax_refundMap : EntityTypeConfiguration<prl_income_tax_refund>
    {
        public prl_income_tax_refundMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("prl_income_tax_refund", "payroll_system");
            ...
            this.HasRequired(t => t.prl_employee)
                .WithMany(t => t.prl_income_tax_refund)
