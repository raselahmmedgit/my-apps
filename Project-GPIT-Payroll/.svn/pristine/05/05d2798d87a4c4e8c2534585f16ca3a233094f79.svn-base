...
{
    public class prl_allowance_configurationMap : EntityTypeConfiguration<prl_allowance_configuration>
    {
        public prl_allowance_configurationMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("prl_allowance_configuration", "payroll_system");
            ...
            this.Property(t => t.exempted_amount).HasColumnName("exempted_amount");
            this.Property(t => t.exempted_percentage).HasColumnName("exempted_percentage");
            ...
            this.HasRequired(t => t.prl_allowance_name)
                .WithMany(t => t.prl_allowance_configuration)
