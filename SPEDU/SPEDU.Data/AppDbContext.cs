...
namespace SPEDU.Data
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<AppUserProfile> UserProfile { get; set; }
    ...
    public class DbInitializer : DropCreateDatabaseIfModelChanges<AppDbContext>
    {
        ...
        var appRightPermissionList = new List<AppRightRolePermission>
                    {
                        #region SuperAdmin
                        new AppRightRolePermission {AppRightId = Convert.ToInt32(RightEnum.Add), RoleId = Convert.ToInt32(RoleEnum.SuperAdmin), CreatedBy = Convert.ToInt32(UserEnum.SuperAdmin), CreatedDate = DateTime.Now, UpdatedBy = Convert.ToInt32(UserEnum.SuperAdmin), UpdatedDate = DateTime.Now, IsDelete = false, DeletedBy = Convert.ToInt32(UserEnum.SuperAdmin), DeletedDate = DateTime.Now},
        ...
        var appInformationList = new List<AppApplicationInfo>
                    {
                        new AppApplicationInfo {AppInformationId = Convert.ToInt32(ApplicationInformationEnum.HeaderTitle), Name = "Application Title", Key = ApplicationInformationEnum.HeaderTitle.ToString(), Value = "", Description = "Application Title", CreatedBy = Convert.ToInt32(UserEnum.SuperAdmin), CreatedDate = DateTime.Now, UpdatedBy = Convert.ToInt32(UserEnum.SuperAdmin), UpdatedDate = DateTime.Now, IsDelete = false, DeletedBy = Convert.ToInt32(UserEnum.SuperAdmin), DeletedDate = DateTime.Now},
                        new AppApplicationInfo {AppInformationId = Convert.ToInt32(ApplicationInformationEnum.HeaderText), Name = "Application Header Text", Key = ApplicationInformationEnum.HeaderText.ToString(), Value = "", Description = "Application Header Text", CreatedBy = Convert.ToInt32(UserEnum.SuperAdmin), CreatedDate = DateTime.Now, UpdatedBy = Convert.ToInt32(UserEnum.SuperAdmin), UpdatedDate = DateTime.Now, IsDelete = false, DeletedBy = Convert.ToInt32(UserEnum.SuperAdmin), DeletedDate = DateTime.Now},
                        ...
                        new AppApplicationInfo {AppInformationId = Convert.ToInt32(ApplicationInformationEnum.MetaAuthor), Name = "Head Meta Author", Key = ApplicationInformationEnum.MetaAuthor.ToString(), Value = "", Description = "Head Meta Author", CreatedBy = Convert.ToInt32(UserEnum.SuperAdmin), CreatedDate = DateTime.Now, UpdatedBy = Convert.ToInt32(UserEnum.SuperAdmin), UpdatedDate = DateTime.Now, IsDelete = false, DeletedBy = Convert.ToInt32(UserEnum.SuperAdmin), DeletedDate = DateTime.Now},
                        new AppApplicationInfo {AppInformationId = Convert.ToInt32(ApplicationInformationEnum.MetaKeywords), Name = "Head Meta Keywords", Key = ApplicationInformationEnum.MetaKeywords.ToString(), Value = "", Description = "Head Meta Keywords", CreatedBy = Convert.ToInt32(UserEnum.SuperAdmin), CreatedDate = DateTime.Now, UpdatedBy = Convert.ToInt32(UserEnum.SuperAdmin), UpdatedDate = DateTime.Now, IsDelete = false, DeletedBy = Convert.ToInt32(UserEnum.SuperAdmin), DeletedDate = DateTime.Now},
                        new AppApplicationInfo {AppInformationId = Convert.ToInt32(ApplicationInformationEnum.MetaDescription), Name = "Head Meta Description", Key = ApplicationInformationEnum.MetaDescription.ToString(), Value = "", Description = "Head Meta Description", CreatedBy = Convert.ToInt32(UserEnum.SuperAdmin), CreatedDate = DateTime.Now, UpdatedBy = Convert.ToInt32(UserEnum.SuperAdmin), UpdatedDate = DateTime.Now, IsDelete = false, DeletedBy = Convert.ToInt32(UserEnum.SuperAdmin), DeletedDate = DateTime.Now},
