...
namespace SPEDU.Domain.Helpers
{
    ...
    /// </summary>
    public static class CurrentSessionHelper
    {
        /// <summary>
        ...
        public static CurrentUserRequest CurrentUserRequest
        {
            get
            {
                return (CurrentUserRequest)Get("CurrentUserRequest");
            }
            set
            {
                Set("CurrentUserRequest", value);
            }
        }
