...
namespace rabapp.Service.Common.Helper
{
    public class ImageUtility
    {
        ...
        public Size GetPreferredImageSize(Constants.ImageDimensions dimension)
        {
            var size = new Size();
            switch (dimension)
            {
                case Constants.ImageDimensions.Common:
        ...
        public bool ImageSaveToPath(string fullRelativePath, byte[] photobytes, string fileName, Constants.ImageDimensions dimensions)
        {
            ...
            try
            {
                if (photobytes != null)
                {
                    ...
                    {
                        DirectoryInfo directoryInfo = Directory.CreateDirectory(fullRelativePath);
                    }
                    ...
                    File.WriteAllBytes(fullRelativePath + "\\" + fileName, photobytes);
